...
public class GridLayoutMouseEvent extends JFrame{
    ...
    private ImageIcon xImage = new ImageIcon("labsheet12/exercise2/images/cross.gif");
    private ImageIcon oImage = new ImageIcon("labsheet12/exercise2/images/nought.gif");
